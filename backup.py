...
EXCLUDE_PRESETS = {
    ...
    "Social Media (15)": [
        ...
        "whatsapp.com", "telegram.org", "discord.com", "clubhouse.com", "mastodon.social"
    ],
    "Video Platforms (12)": [
        "youtube.com", "vimeo.com", "dailymotion.com", "twitch.tv", "rumble.com",
        "bitchute.com", "odysee.com", "brighteon.com", "lbry.tv", "streamable.com",
        "wistia.com", "vidyard.com"
    ],
    "Wiki & Reference (18)": [
        "wikipedia.org", "wikihow.com", "wikimedia.org", "wikidata.org", "britannica.com",
        "dictionary.com", "thesaurus.com", "merriam-webster.com", "investopedia.com",
        "techopedia.com", "vocabulary.com", "urbandictionary.com", "answers.com",
        "quora.com", "stackexchange.com", "yahoo.com", "ask.com", "reference.com"
    ],
    "E-commerce (20)": [
        "amazon.com", "ebay.com", "walmart.com", "target.com", "alibaba.com",
        "aliexpress.com", "etsy.com", "shopify.com", "bestbuy.com", "homedepot.com",
        "lowes.com", "costco.com", "wayfair.com", "overstock.com", "newegg.com",
        "wish.com", "craigslist.org", "mercari.com", "poshmark.com", "depop.com"
    ],
    "News Media (25)": [
        ...
        "huffpost.com", "businessinsider.com", "time.com", "newsweek.com", "npr.org",
    ...
    "Tech Giants (15)": [
        ...
        "intel.com", "cisco.com", "hp.com", "dell.com", "samsung.com"
    ],
    "Job Boards (12)": [
        "indeed.com", "linkedin.com", "glassdoor.com", "monster.com", "careerbuilder.com",
        "ziprecruiter.com", "simplyhired.com", "dice.com", "flexjobs.com", "remote.co",
        "weworkremotely.com", "angellist.com"
    ],
    "Review Sites (15)": [
        "yelp.com", "tripadvisor.com", "trustpilot.com", "g2.com", "capterra.com",
        "sitejabber.com", "consumeraffairs.com", "bbb.org", "productreview.com.au",
        "reviews.io", "feefo.com", "resellerratings.com", "influenster.com",
        "angi.com", "homestars.com"
    ],
    "Government & Education (20)": [
        "usa.gov", "gov.uk", "canada.ca", "australia.gov.au", "europa.eu",
        "whitehouse.gov", "irs.gov", "fda.gov", "cdc.gov", "nih.gov",
        "nsf.gov", "nasa.gov", "ed.gov", "sba.gov", "ftc.gov",
        "mit.edu", "harvard.edu", "stanford.edu", "berkeley.edu", "yale.edu"
    ],
    "File Sharing (10)": [
        "dropbox.com", "drive.google.com", "onedrive.com", "box.com", "mediafire.com",
        "mega.nz", "wetransfer.com", "sendspace.com", "zippyshare.com", "4shared.com"
    ],
    "Forums & Communities (15)": [
        "reddit.com", "stackoverflow.com", "stackexchange.com", "medium.com", "dev.to",
        "hackernews.ycombinator.com", "producthunt.com", "indiehackers.com", "discord.com",
        "slack.com", "discourse.org", "phpbb.com", "vbulletin.com", "xenforo.com", "invision.community"
    ],
    "Design & Creative (12)": [
        "behance.net", "dribbble.com", "deviantart.com", "artstation.com", "flickr.com",
        "500px.com", "unsplash.com", "pexels.com", "pixabay.com", "shutterstock.com",
        "gettyimages.com", "canva.com"
    ],
    "Development Tools (15)": [
        "github.com", "gitlab.com", "bitbucket.org", "sourceforge.net", "codepen.io",
        "jsfiddle.net", "codesandbox.io", "replit.com", "glitch.com", "heroku.com",
        "vercel.com", "netlify.com", "cloudflare.com", "aws.amazon.com", "azure.microsoft.com"
    ],
    "Documentation (10)": [
        "readthedocs.io", "docs.python.org", "developer.mozilla.org", "w3schools.com",
        "geeksforgeeks.org", "tutorialspoint.com", "javatpoint.com", "programiz.com",
        "freecodecamp.org", "codecademy.com"
    ],
    "Marketing & SEO (12)": [
        "moz.com", "semrush.com", "ahrefs.com", "hubspot.com", "mailchimp.com",
        "constantcontact.com", "sendinblue.com", "hootsuite.com", "buffer.com",
        "sproutsocial.com", "later.com", "tailwindapp.com"
    ],
    "Streaming & Entertainment (10)": [
        "spotify.com", "soundcloud.com", "pandora.com", "deezer.com", "tidal.com",
        "hulu.com", "disneyplus.com", "hbomax.com", "primevideo.com", "peacocktv.com"
    ],
    "All Popular Sites (120+)": []  # Will be combined from all above
}

# Combine all for "All Popular Sites"
all_sites = []
for key, sites in EXCLUDE_PRESETS.items():
    if key not in ["None", "All Popular Sites (120+)"]:
        all_sites.extend(sites)
EXCLUDE_PRESETS["All Popular Sites (120+)"] = sorted(list(set(all_sites)))
...
def snov_get_domain_emails(domain, access_token):
    """Get emails from domain using Snov.io API v2"""
...
def call_dataforseo_serp_api(keywords, login, password, location="United States", language="English", device="desktop", batch_mode=False):
    """Call DataForSEO SERP API - Sequential mode by DEFAULT"""
...
with tab1:
    ...
    # NEW: Exclude Presets Section
    st.subheader("🚫 Exclude Domains")
    ...
    with col1:
        preset_selection = st.selectbox(
            "Quick Presets",
            options=list(EXCLUDE_PRESETS.keys()),
            help="Select a preset category to exclude popular sites"
        )

        if preset_selection != "None":
            preset_count = len(EXCLUDE_PRESETS[preset_selection])
            st.info(f"✅ {preset_count} domains in preset")

            with st.expander("View Preset Domains"):
                st.write(", ".join(EXCLUDE_PRESETS[preset_selection][:50]))
                if len(EXCLUDE_PRESETS[preset_selection]) > 50:
                    st.write(f"... and {len(EXCLUDE_PRESETS[preset_selection]) - 50} more")

    with col2:
        custom_excludes = st.text_area(
            "Custom Exclude Domains (one per line)", 
            placeholder="example.com\nanothersite.com",
            help="Add additional domains to exclude beyond the preset",
            height=150
        )
            ...
            with st.spinner("Extracting SERP results..."):
                ...
                if 'error' in api_response:
                    ...
                    if df_results is not None and len(df_results) > 0:
                        # Combine preset and custom excludes
                        all_excludes = []

                        # Add preset domains
                        if preset_selection != "None":
                            all_excludes.extend(EXCLUDE_PRESETS[preset_selection])

                        # Add custom domains
                        if custom_excludes:
                            custom_list = [d.strip() for d in custom_excludes.split("\n") if d.strip()]
                            all_excludes.extend(custom_list)
                        ...
                        if all_excludes:
                            ...
                            df_results = df_results[~df_results['domain'].isin(all_excludes)]
                            excluded_count = original_count - len(df_results)
                            if excluded_count > 0:
                                st.info(f"🚫 Excluded {excluded_count} results from {len(all_excludes)} domains")
...
st.markdown("""
    <div style='text-align: center; color: #666; padding: 1rem;'>
        <p><strong>SERP & Contact Extraction Tool v4.1 - With Exclude Presets</strong></p>
        <p><small>✅ 120+ Preset Exclusions • ✅ Sequential Mode • ✅ Parallel Snov.io • ✅ Smart Discovery</small></p>
    </div>
""", unsafe_allow_html=True)
